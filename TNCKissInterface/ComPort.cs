...
namespace TNCKissInterface
{
    ...
    public class COMPort
    {
        ...
        public COMPort(String comPort, Int32 baud)
        {
            COMPortInit(comPort, baud, false, "", 0);            // JNW Apr15
        }
        ...
        {
            COMPortInit(comPort, 0, false, Host, Port);
        }

        public COMPort(String comPort, Int32 baud, Boolean loopback)
        {
            COMPortInit(comPort, baud, loopback, "", 0);         // JNW Apr15
        }
        ...
        void COMPortInit(String comPort, Int32 baud, Boolean loopback, String Host, Int32 Port)            // JNW Apr15
        {
            //
            // Initialization
            // 
